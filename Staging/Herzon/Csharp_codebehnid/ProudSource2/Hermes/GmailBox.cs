...
namespace Hermes
{
    ...
    class GmailBox
    {
        ...
        /// Class constructor.
        /// </summary>
        public GmailBox( String keyFileName )
        {
            ...
            PrivateKeyFile = PrivateKeyFile.Remove(PrivateKeyFile.Count() - 10) + @"\Resources\";
        ...
        {
            GmailService service = new GmailService(new BaseClientService.Initializer() { HttpClientInitializer = get_GmailCred });
        }
    }
}
